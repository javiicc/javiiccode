...
// import MousePosition from "./___mouse-position";
...
//   return (
//     <div
//       className={`relative h-full rounded-xl p-[0px]
//       before:absolute before:w-80 before:h-80 before:-left-40 before:-top-40
//       before:bg-slate-400 before:rounded-full before:opacity-0 before:pointer-events-none
...
//       after:hover:opacity-10 after:z-30 after:blur-[100px] overflow-hidden ${className}`}
//     >
//       {/* before:bg-slate-400  after:bg-indigo-500*/}
//       {children}
//     </div>
//   );
// }
