...
sections:
  [
    { id: "item_1", label: "Intuition", href: "#intuition", level: "level_0" },
    {
      id: "item_2",
      label: "From a piece of text to embedding vectors",
      href: "#from-a-piece-of-text-to-embedding-vectors",
      level: "level_0",
    },
    {
      id: "item_3",
      label: "Sparse vectors vs Dense vectors",
      href: "#sparse-vectors-vs-dense-vectors",
      level: "level_1",
    },
    {
      id: "item_4",
      label: "Word Embeddings and Sentence Embeddings",
      href: "#word-embeddings-and-sentence-embeddings",
      level: "level_1",
    },
    {
      id: "item_5",
    ...
    {
      id: "item_7",
      label: "The Continuous Bag of Words Model",
      href: "#the-continuous-bag-of-words-model",
      level: "level_4",
    },
    {
      id: "item_8",
      label: "The Skip-gram Model",
      href: "#the-skip-gram-model",
      level: "level_4",
    },
    {
      id: "item_9",
      label: "Sentence Embeddings",
      href: "#sentence-embeddings",
      level: "level_2",
    },
    {
      id: "item_10",
      label: "OpenAI Embeddings API",
      href: "#openai-embeddings-api",
      level: "level_0",
    },
    {
      id: "item_11",
    ...
    },
    {
      ...
      href: "#load-and-prepare-data",
      level: "level_2",
    },
    {
      id: "item_14",
      label: "Compute embedding vectors",
      href: "#compute-embedding-vectors",
      level: "level_2",
    },
    {
      id: "item_15",
      label: "Reduce data dimensionality",
      href: "#reduce-data-dimensionality",
      level: "level_2",
    },
    {
      id: "item_16",
    ...
    {
      id: "item_17",
      label: "High dimensional visualization",
      href: "#high-dimensional-visualization",
      level: "level_1",
    },
  ]
---
